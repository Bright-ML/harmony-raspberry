...
![image-20210121164252514](2.1、增加新单板.assets/image-20210121164252514.png)

配置完后保存退出，生成的配置文件可以查看\kernel\liteos_a\\.config，如下。
...
## 3.3、kernel\liteos_a\kernel\common\los_config.h
